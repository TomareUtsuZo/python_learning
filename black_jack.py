    ...
    def Win(self, dealer_score, dealer_hand):
        ...
        if self.score > 21:
            ...
            if dealer_hand == 2 and len(self.hand) == 2: # and in case both hit black jack
                ...
                self.money = self.bet * 2.5 # pay extra
...
carl = Player('Carl', [game_deck.pop(0), game_deck.pop(0)])
...
while True:
    ...
    print(carl)
    while carl.score < 21:
        hit_it = input("Do you want to hit? (y) ")
        if hit_it.lower() == 'y':
    ...
    quit_it = input("Did you want to play again?(y) ")
    if quit_it.lower() != 'y':
        break
